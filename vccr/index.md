## Veeam Connect Cloud Replication (VCCR)

- [VMWare Solutions on IBM Cloud](https://cloud.ibm.com/infrastructure/vmware-solutions/console)
- [VMware Solutions Shared with Veeam CCR](https://cloud.ibm.com/docs/vmwaresolutions?topic=vmwaresolutions-shared_veeam#shared_veeam-cloud-connect)
- [What is Veeam Cloud Connect Replication](https://www.veeam.com/cloud-connect-replication-service-providers.html)
- [Veeam CCR Documentation](https://helpcenter.veeam.com/docs/backup/cloud/cloud_replication.html)
